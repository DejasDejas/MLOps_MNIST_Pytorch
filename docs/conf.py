...
# If true, '()' will be appended to :func: etc. cross-references text.
...
htmlhelp_basename = 'MLOps_MNIST_Pytorchdoc'
...
latex_documents = [
    ('index',
     'MLOps_MNIST_Pytorch.tex',
     u'MLOps_MNIST_Pytorch Documentation',
